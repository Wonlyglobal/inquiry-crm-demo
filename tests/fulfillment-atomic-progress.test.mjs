...
test("order progress handler is not executed during CRM startup",()=>{
  ...
  assert.equal((html.slice(functionStart,functionEnd).match(/\$\("#order-progress-form"\)\.onsubmit/g)||[]).length,1);
});
