...
export function researchSummary(payload){
 ...
 return {source:RESEARCH_URL,as_of:/^\d{4}-\d{2}-\d{2}$/.test(payload.generatedAt)?payload.generatedAt:null,sample_count:payload.companies.length,countries:grouped(countries),categories:grouped(categories),unverified_count:missing,limits:'背调索引样本，非市场总量或成交概率；小于5条的分组不披露；无企业名称、域名、联系人、联系方式、商业判断或CRM客户关联。'};
}
