...
const audience='wonly-material-file',path='/api/integrations/crm/file';
...
export async function signMaterialFileRequest({body,actor,privateJwk,now=Date.now()}){
...
export async function verifyMaterialFileRequest({proof,body,publicJwk,now=Date.now()}){
 try{
